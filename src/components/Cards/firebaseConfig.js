...
import { getFirestore, collection, doc, onSnapshot, query, orderBy, limit, getDocs } from 'firebase/firestore';
...
export { db, collection, doc, onSnapshot, query, orderBy, limit, getDocs };