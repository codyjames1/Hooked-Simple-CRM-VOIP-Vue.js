...
import { getFirestore, collection, doc, onSnapshot, query, orderBy, limit, deleteDoc, updateDoc, getDocs } from 'firebase/firestore';
...
export { db, collection, doc, onSnapshot, query, orderBy, limit, deleteDoc, updateDoc, getDocs};