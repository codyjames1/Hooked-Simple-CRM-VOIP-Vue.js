...
import { getFirestore, collection, doc, onSnapshot, query, orderBy, limit, addDoc,serverTimestamp } from 'firebase/firestore';
...
export { db, collection, doc, onSnapshot, query, orderBy, limit, addDoc, serverTimestamp };